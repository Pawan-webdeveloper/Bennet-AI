...
const EmbedClient = ({ownerId}: {ownerId: string}) => {
  ...
  return (
    <div className='min-h-screen bg-zinc-50 text-zinc-900'>
        <div className='sticky top-0 z-40 bg-white border-b border-zinc-200'>
            ...
            <div className='max-w-7xl mx-auto px-16 h-16 flex items-center justify-between'>
                <div className='text-lg cursor-pointer font-semibold' onClick={()=> navigate.push("/")}>Bennet <span className='text-zinc-400'>AI</span></div>
                <button onClick={()=> navigate.push("/dashboard")} className='px-4 py-2 rounded-lg border border-zinc-300 text-sm hover:bg-zinc-100 transition'>Back to Dashbaord</button>
            </div>
        </div>
    ...
    <div className='flex justify-center px-4 py-14'>
        ...
        >
            <h1 className='text-2xl mb-2 font-semibold'>Embed Chatbot</h1>
            ...
            <ol className='space-y-3 text-sm text-zinc-600 list-decimal list-inside mt-8'>
            ...
            <div className='mt-14'>
                ...
                <p className='text-sm text-zinc-500 mb-6'>This is how the chatBot will appear in your website</p>
                ...
                <div className='relative h-64 sm:h-72 p-6 text-zinc-400 text-sm'>
                    ...
                    <div className='p-3 space-y-2 bg-zinc-50'>
                        <div className='bg-zinc-200 text-zinc-800 text-xs px-3 py-2 rounded-lg w-fit'>hi! how can i help you?</div>
                         <div className='bg-black text-white text-xs px-3 py-2 rounded-lg w-fit justify-end'>what is the return policy</div>
                    </div>
